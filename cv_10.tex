...
\header{Pierre-Louis}{TILAK}{Software Development Manager} % Your name and current job title/field
...
France
~
\includegraphics[scale=0.02]{phone} +33 6 17 83 77 13
...
\item Python development: Data Analysis over log database %(Jupyter Notebook/Pandas/Numpy/Plotly)% Unitary Tests (Behave), Automatisation of Autopilot simulator
